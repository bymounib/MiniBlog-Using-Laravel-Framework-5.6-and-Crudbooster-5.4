    ...
    <div class="site-section" style="background-color: rgb(247, 247, 247)">
      <div class="container">
        <div class="row mb-5">
          <div class="col-12">
            @if ($re==null)
            <h3>Il n'y a aucun article dans cette catégorie</h3>
        @else
            <h2 >Articles de {{$re[0]->name_category}}</h2>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 mb-4 " >
            <div class="entry2 img-thumbnail" style="padding: 20px; height:750px;">
              <a href='{{url("article/$row->id")}}'><img src="{{ asset("images/article/$row->photo")}}" alt="Image" class=" img-fluid rounded col-12" style="height:200px;"></a>
              <div class="excerpt">
              ...
              <h2><a href='{{url("article/$row->id")}}'> {{str_limit(strip_tags($row->titre),80)}}</a></h2>
              ...
              <a href='{{url("article/$row->id")}}'><button type="button" class="btn btn-outline-primary" >Voir plus</button></a>
            </div>
            </div>
          </div>
          @endforeach
